...
class Product extends Model
{
    ...
    protected $appends = ['rating','image','publisher_info','published_by','product_images','is_favorits','phone','my_favorits','creation_date'];
    ...
    {
        return (@$this->user->profile) ? $this->user->profile->social_name : '';
    }
